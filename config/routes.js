...
import { try_auth, require_auth, require_no_auth } from "../config/auth.js"
...
check('user_username').isLength({ min: 6 }).withMessage('Username is less than 6 chars!'),
check('user_password').isLength({ min: 6 }).withMessage('Password is less than 6 chars!'),
